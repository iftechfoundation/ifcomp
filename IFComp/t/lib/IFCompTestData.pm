...
sub add_test_data_to_schema {
    ...
    $schema->populate(
        ...
        [   [ 'id', 'question_text', 'disabled' ],
            ...
            [ 4, "Hate speech, discriminatory content, or content targeting people based on protected characteristics",0],
            [ 5, "Graphic or realistic depictions of violence/blood/gore",0],
