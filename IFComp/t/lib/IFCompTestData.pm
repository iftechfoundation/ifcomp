...
sub add_test_data_to_schema {
    ...
    $schema->populate(
        ...
        [   [   'id',    'author',   'title', 'comp',
            ...
            [   103, 1, 'Test Parchment game',
                1,   2, 'parchment', '2e44258d59ccfca797d8',
            ],
            [   104, 1, 'Test Z-code website',
                1,   3, 'inform-website', '570afe4434136a35b97e',
            ],
            [   105, 1, 'Test non-Inform website',
                1,   4, 'website', '70d146f955a9be7ee657',
            ],
            [   106, 1, 'Test HTML page',
                1,   5, 'website', '11740856d5392f4f099c',
            ],
            [   107, 1, 'Test Z-code website with buried story file',
                1,   6, 'inform-website', '62584e5198e8ce160921',
            ],
            [   108, 1, 'Test Quest game',
                1,   7, 'quest', 'ec0460756f55e774c47a',
            ],
            [   109, 1, 'Test TADS game',
                1,   8, 'tads', '701d72d3c91885849902',
            ],
