...
ok(
    file_exists( 100, 'index.html' ),
    'Generated an index.html file.',
);
ok(
    file_contains( 100, 'index.html', qr{/static/interpreter/parchment/} ),
    'Links to local parchment.',
);
ok(
    file_contains( 100, 'index.html', qr{/static/interpreter/transcript_recorder/} ),
...
ok(
    file_exists( 101, 'index.html' ),
    'Generated an index.html file.',
);
ok(
    file_exists( 101, 'Naked Glulx.gblorb.js' ),
    'Generated a JavaScript game file.',
);
ok(
    file_contains( 101, 'index.html', qr{/static/interpreter/quixe/} ),
...
ok(
    file_contains( 102, 'play.html', qr{/static/interpreter/quixe/} ),
    'Links to local interpreter.',
);
...
ok(
    file_contains( 103, 'play.html', qr{/static/interpreter/parchment/} ),
    'Links to local interpreter.',
);
...
ok(
    file_contains( 103, 'play.html', qr{/static/interpreter/transcript_recorder/} ),
    'Links to local transcript recorder.',
);
