...
out.push(retval+('Glk.glk_'+func.name).replace('glk_gar','gar')+'('+argjoin.join(', ')+');');console.log(out)
if(mayblock){out.push('if (glkret === Glk.DidNotReturn) {');out.push('  self.set_blocked_selector('+func.id+', callargs);');out.push('  return glkret;');out.push('}');}
